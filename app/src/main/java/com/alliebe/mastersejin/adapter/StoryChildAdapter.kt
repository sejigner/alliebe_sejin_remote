...
import com.alliebe.mastersejin.adapter.StoryChildAdapter.ViewHolder
import com.alliebe.mastersejin.dtos.StoryChildDTO

class StoryChildAdapter(private val childData: List<StoryChildDTO>?) : RecyclerView.Adapter<ViewHolder>() {
